...
- [ ] Tipos básicos, Interfaces y Type Aliases (Diferencias y casos de uso).
- [ ] Generics: Estructuras reutilizables fuertemente tipadas.
...
### [ ] Semana 3: Frontend con React y TypeScript
- [ ] Inicialización del ecosistema Frontend con Vite + React + TS.
- [ ] Tipado estricto de Componentes (Props y Children).
...
- [ ] Deploy continuo del Frontend (Vercel) y pruebas E2E en producción.
